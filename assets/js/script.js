document.addEventListener("DOMContentLoaded", function () {
    ...
    // this function cannot get username due to this project didn't have the database to store the user data, everything is store on user local storage
      const userName = getUserName(); // function to get the user's name but since this project didn't allow user to input their name so I decide to return it as "Buddy" instead of name's user
  ...
  // function to change background color theme
    ...
    // for display the card entry content on homepage
